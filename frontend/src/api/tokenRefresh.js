...
let refreshPromise = null; //test-nico

export class ApiError extends Error { //test-nico
...
export async function apiError(response) { //test-nico
	let body = null;
	try {
...
export async function refreshAccessToken(refreshToken) { //test-nico
...
export async function refreshAuthSession(sessionUsed) { //test-nico
