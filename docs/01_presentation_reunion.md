...
Le but de cette reunion est de proposer une direction commune pour `ft_transcendence`.

On veut valider :

- le concept du projet ;
- la stack technique ;
- le decoupage du travail ;
- les modules vises ;
- les risques principaux ;
- le minimum a livrer avant d'ajouter des bonus.

Ce document n'est pas le README final et n'est pas le support d'evaluation final. Il sert a discuter avec l'equipe avant de commencer vraiment.
