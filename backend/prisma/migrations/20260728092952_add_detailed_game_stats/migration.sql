...
*/
-- AlterTable
ALTER TABLE "GameRun" ADD COLUMN     "abandoned" BOOLEAN NOT NULL,
ADD COLUMN     "lost" BOOLEAN NOT NULL;

-- AlterTable
ALTER TABLE "PlayerRunStats" ADD COLUMN     "damageDealt" INTEGER NOT NULL,
ADD COLUMN     "damageReceived" INTEGER NOT NULL,
ADD COLUMN     "deaths" INTEGER NOT NULL,
ADD COLUMN     "upgrade1" INTEGER NOT NULL,
ADD COLUMN     "upgrade2" INTEGER NOT NULL,
ADD COLUMN     "upgrade3" INTEGER NOT NULL;
