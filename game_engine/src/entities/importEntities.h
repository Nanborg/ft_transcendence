...
#include <entities/PlayerEntity.hpp>				// done
#include <entities/WallEntity.hpp>					// done
													//
#include <entities/WalkingGoobEntity.hpp>			// done (-att)
#include <entities/ShootingGoobEntity.hpp>			//
#include <entities/TankGoobEntity.hpp>				//
#include <entities/LordGoobEntity.hpp>				//
													//
