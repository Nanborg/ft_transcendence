...
AbstractMovingEntity::AbstractMovingEntity( unsigned int type, int size, int posX, int posY, int velX, int velY ): AbstractEntity(type, size, posX, posY), _velX(velX), _velY(velY) {}
